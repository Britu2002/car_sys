...
document.location = 'admin-dash.php'; </script>";
} else{
...
<body >
	...
	<div class="login-page bk-img" style="background-image: linear-gradient(rgb(69, 166, 208),blue);">
		<div class="form-content">
			...
			<p style="margin-top: 4%" align="center"><a href="/car_sys/home.php">Back to Home</a>	</p>
							</div>
