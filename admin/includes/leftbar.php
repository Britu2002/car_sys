	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="admin-dash.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
...
<li><a href="#"><i class="fa fa-car"></i> Cars</a>
					<ul>
						<li><a href="add_car.php">Post a Car</a></li>
...
<li><a href="#"><i class="fa fa-sitemap"></i> Bookings</a>
				...
				<li><a href="queries.php"><i class="fa fa-desktop"></i> Manage Conatctus Query</a></li>
				<li><a href="reg-users.php"><i class="fa fa-users"></i> Reg Users</a></li>
			<li><a href="feedback.php"><i class="fa fa-files-o"></i> Manage Feedback</a></li>
