...
$id=$_GET['imgid'];
move_uploaded_file($_FILES["img1"]["tmp_name"],"imgs/vechileimage/".$_FILES["img1"]["name"]);
$sql = "update car set car_img3='$vimage1' where car_id=$id";
echo $sql;
...
if(mysqli_num_rows($res)>0){
	while($row = $res->fetch_assoc()){
			...
			?>
<?php //echo $row['car_img1'];?>
<div class="col-sm-8">
<img src="imgs/vechileimage/<?php echo $row['car_img3'];?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
